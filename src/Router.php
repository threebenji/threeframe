 ...
 *
 * @author https://github.com/noahbuscher/Macaw
 */
class Router
{
    ...
    {
        $uri = dirname(Request::server("request_uri", "")) . '/' . $params[0];
        $callback = $params[1];
                    ...
                    if (self::$methods[$pos] == $method || self::$methods[$pos] == 'ANY') {
                        ...
                        if (!is_object(self::$callbacks[$pos])) {
                            ...
                            if (!method_exists($controller, $segments[1])) {
                                Response::write(500, "controller and action not found");
                            } else {
